// src/ai/flows/generate-clues-from-chat.ts
...
3.  **Clue Synthesis:** For each clustered topic, synthesize a short, intriguing clue. The clue should be a punchy phrase that captures the essence of the topic, making it sound unique and personal. For example, if the user talked about wanting to try authentic pasta in Italy, a good clue would be "Wants to eat real pasta in Italy". If they mentioned loving "Lord of the Rings," a clue could be "Thinks Lord of the Rings is the best movie trilogy."
